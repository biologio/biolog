...
Fact = Astro.Class({
    ...
    fields: {
        ...
        num: {type: "number"}, //the numeric value
        ...
        startDate: {type: "date"}, //the start date
        startFlag: {type: "number", default: 0}, //the start date flag.  0=no comment.  1=beginning of time
        endDate: {type: "date"}, //the end date
        endFlag: {type: "number", default: 0}, //the end date flag.  0=no comment.  1=forever
        ...
        valid: {type: "number", default: 1}, //the validity score of the data.  1=valid, 0=invalid
